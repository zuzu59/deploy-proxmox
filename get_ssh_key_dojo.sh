#!/usr/bin/env bash
#Petit script pour récupérer toutes les clefs ssh du Dojo sur Github ;-)
#zf210421.1533, zf210924.1103, zf211126.1528

#Usage, simplement faire:
#
# curl https://raw.githubusercontent.com/zuzu59/deploy-proxmox/master/get_ssh_key_dojo.sh | bash
...
curl https://github.com/laurent-indermuehle.keys >> ~/.ssh/authorized_keys
